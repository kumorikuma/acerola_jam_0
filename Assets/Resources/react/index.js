...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@font-face{font-family:\"Frankfurter\";src:url(resource:FrankfurterStdRegularSDF)}*{font-family:\"Frankfurter\"}.padding-md{padding:12px}.padding-lg{padding:24px}.spacer{flex-grow:1}.flex-column{display:flex;flex-direction:column}.flex-row{display:flex;flex-direction:row}.align-center{align-items:center}.justify-center{justify-content:center}.button{border:none;margin:0;padding:0;background:rgba(0,0,0,0);font-size:64px;color:#fff;padding-top:24px;padding-bottom:24px;padding-left:32px;padding-right:32px;background-color:rgba(0,0,0,0);border-radius:48px}.button:active{background-color:rgba(255,255,255,.3);transform:scale(1.1)}.button:hover{background-color:rgba(255,255,255,.1);transform:scale(1.1)}.score{color:#fff;font-size:24px}.score.text{padding-right:20px}.debug-ui{display:flex;flex-direction:column;padding:6px;position:absolute;width:100%;height:100%;background-color:rgba(0,0,0,0)}.debug-ui .footer{display:flex;flex-direction:row}.debug-ui .text{color:#fff;font-size:24px}.debug-ui .button{font-size:16px;border-radius:12px;border-width:1px;border-style:solid;border-color:#fff;height:40px;width:120px;padding:4px}.main-menu{display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%}.main-menu .content{display:flex;flex-direction:column;align-items:center}.main-menu .content>*:not(:first-child){margin-top:48px}.main-menu .title{margin-top:-128px;margin-bottom:128px;text-align:center;color:#fff;font-size:64px;font-family:\"Frankfurter\"}.main-menu .button{font-family:\"Frankfurter\"}.player-healthbar{width:600px;height:20px;background:linear-gradient(90deg, white 80%, rgba(255, 255, 255, 0.1) 80%, rgba(255, 255, 255, 0.1) 100%)}.boss-healthbar{width:600px;height:20px;background:linear-gradient(90deg, white 80%, rgba(255, 255, 255, 0.1) 80%, rgba(255, 255, 255, 0.1) 100%)}.lives{margin-top:8px}.lives .segments-container{width:200px;height:20px}.lives .segments-container .segments{width:100%;height:20px;display:flex;flex-direction:row;box-sizing:border-box}.lives .segments-container .segments .segment{flex:1;background-color:rgba(255,255,255,.1)}.lives .segments-container .segments .segment.active{background-color:#fff}.lives .segments-container .segments>*:not(:first-child){margin-left:8px}.hud{display:flex;flex-direction:column;height:100%}.hud .fullscreen-overlay{position:absolute;width:100%;height:100%}.hud .fullscreen-overlay .reticle{position:absolute;left:960px}.hud .fullscreen-overlay .reticle .cooldowns-container{position:absolute;top:50%;left:50%}.hud .fullscreen-overlay .reticle .cooldowns-container .cooldowns{position:relative;transform:translate(-50%, -50%);width:350px;height:350px;border-radius:50%;overflow:hidden;background:conic-gradient(transparent 0, transparent 22%, white 22%, white 40%, transparent 40%, transparent 60%, white 60%, white 78%, transparent 78%);mask:radial-gradient(circle, transparent 68%, black 100%)}.hud .fullscreen-overlay .reticle .decoration{position:absolute;top:50%;left:50%}.hud .fullscreen-overlay .reticle .decoration .circle-outer{position:absolute;width:320px;height:320px;border:4px solid rgba(255,255,255,.1);border-radius:50%;top:50%;left:50%;transform:translate(-50%, -50%)}.hud .fullscreen-overlay .reticle .decoration .circle-outer-2{position:absolute;width:304px;height:304px;border:2px solid rgba(255,255,255,.1);border-radius:50%;top:50%;left:50%;transform:translate(-50%, -50%)}.hud .fullscreen-overlay .reticle .decoration .circle-inner{position:absolute;width:24px;height:24px;border:2px solid rgba(255,255,255,.1);border-radius:50%;top:50%;left:50%;transform:translate(-50%, -50%)}.hud .fullscreen-overlay .reticle .crosshair{position:absolute;top:50%;left:50%}.hud .fullscreen-overlay .reticle .crosshair .crosshair-top{position:absolute;width:4px;height:20px;background-color:rgba(255,255,255,.5);transform:translate(-50%, -50%);top:-62px}.hud .fullscreen-overlay .reticle .crosshair .crosshair-down{position:absolute;width:4px;height:20px;background-color:rgba(255,255,255,.5);transform:translate(-50%, -50%);top:62px}.hud .fullscreen-overlay .reticle .crosshair .crosshair-right{position:absolute;width:28px;height:4px;background-color:rgba(255,255,255,.5);transform:translate(-50%, -50%);left:62px}.hud .fullscreen-overlay .reticle .crosshair .crosshair-left{position:absolute;width:28px;height:4px;background-color:rgba(255,255,255,.5);transform:translate(-50%, -50%);left:-62px}.boss-stats{align-items:flex-end}.pause-menu{height:100%;display:flex;flex-direction:column;justify-content:center;align-items:center}.pause-menu .text{margin-top:42px;font-size:42px}.pause-menu .title{margin-bottom:128px;color:#fff;font-size:92px}.pause-menu .subtext{color:#fff;font-size:36px;margin-bottom:64px}.pause-menu .bodytext{color:#fff;font-size:32px;margin-bottom:24px}.pause-menu .highlighted{color:#f6ceef;font-size:36px;margin-bottom:24px}.pause-menu .controls-container{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:48px;background-color:rgba(0,0,0,.9);border-radius:42px}.pause-menu .container{padding-left:24px;padding-right:24px;padding-bottom:12px;color:#fff}.pause-menu .container .button{font-size:32px}.pause-menu .row-container{display:flex;flex-direction:row}.pause-menu .mainMenuButton{margin-top:12px;font-size:48px;color:#c3dfee}.pause-menu .container>*:not(:first-child){margin-top:24px}.pause-menu .black-bar{display:flex;flex-direction:column;position:fixed;top:0;left:0;right:0;background:linear-gradient(90deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8) 20%, rgba(0, 0, 0, 0.8) 80%, rgba(0, 0, 0, 0.5))}.pause-menu .gradient-rule{height:1px;width:100%;background-image:linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.8), transparent)}.gameover{display:flex;flex-direction:row;height:100%;padding-left:128px;padding-top:128px;padding-right:128px}.gameover .right-column{align-items:flex-end}.gameover .title{margin-bottom:24px;color:#fff;font-size:92px}.gameover .subtext{color:#fff;font-size:42px;margin-bottom:64px}.gameover .body-text{color:#fff;font-size:32px;margin-bottom:24px}.gameover .mainMenuButton{margin-top:12px;font-size:48px;width:420px}.gameoverLose{display:flex;flex-direction:row;height:100%;padding-left:128px;padding-top:128px;padding-right:128px;background-color:rgba(0,0,0,.1)}.gameoverLose .right-column{align-items:flex-end}.gameoverLose .title{margin-bottom:24px;color:#fff;font-size:92px}.gameoverLose .subtext{color:#fff;font-size:42px;margin-bottom:64px}.gameoverLose .body-text{color:#fff;font-size:32px;margin-bottom:24px}.gameoverLose .mainMenuButton{margin-top:12px;font-size:48px;width:420px}.controls{display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%;padding-left:128px;padding-top:128px;padding-right:128px}.controls .container{display:flex;flex-direction:row}.controls .right-column{align-items:flex-end}.controls .title{margin-top:-128px;margin-bottom:128px;color:#fff;font-size:92px}.controls .subtext{color:#fff;font-size:36px;margin-bottom:64px}.controls .highlighted{color:#f6ceef;font-size:36px;margin-bottom:24px}.controls .mainMenuButton{margin-top:12px;font-size:48px;color:#c3dfee}", ""]);
// Exports
...
function MainMenu(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"main-menu",children:/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"content"})});}
...
function PauseMenu(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"pause-menu",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"black-bar",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"container flex-row spacer",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"text",children:"Paused"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Main Menu",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Continue",onClick:function onClick(){gameLifecycleManager.UnpauseGame();}})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"gradient-rule"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"controls-container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:"Controls"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"row-container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"Press"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" [Left Mouse Click]"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" and "}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" [Right Mouse Click]"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" to attack."})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"row-container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"Press"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" [SPACE]"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" to jump. Press "}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" [SHIFT]"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" to dash."})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"row-container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"TIP: Take down the enemy's shield to"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" stagger"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" it first before meleeing it."})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"row-container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"TIP: You can "}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" dash cancel"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" melee attacks."})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{className:"mainMenuButton",text:"[ Continue ]",onClick:function onClick(){gameLifecycleManager.UnpauseGame();}})]})]});}
;// CONCATENATED MODULE: ./src/reticle.tsx
function lerp(a,b,alpha){return a+alpha*(b-a);}function Reticle(){var globals=useGlobals();var playerPrimaryFireCooldown=useReactiveValue(globals.playerPrimaryFireCooldown);var playerSecondaryFireCooldown=useReactiveValue(globals.playerSecondaryFireCooldown);var primaryFireCooldownPercent=lerp(60,78,playerPrimaryFireCooldown);var secondaryFireCooldownPercent=lerp(22,40,playerSecondaryFireCooldown);var screenSpaceAimPosition=useReactiveValue(globals.screenSpaceAimPosition);var posX=screenSpaceAimPosition.x;var posY=screenSpaceAimPosition.y;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"reticle",style:{bottom:"".concat(posY,"px"),left:"".concat(posX,"px")},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"cooldowns-container",children:/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"cooldowns",style:{background:"conic-gradient(transparent 0, transparent 22%, white 22%, white ".concat(secondaryFireCooldownPercent,"%, transparent ").concat(secondaryFireCooldownPercent,"%, transparent 60%, white 60%, white ").concat(primaryFireCooldownPercent,"%, transparent ").concat(primaryFireCooldownPercent,"%)")}})}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"decoration",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"circle-outer"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"circle-outer-2"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"circle-inner"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"crosshair",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"crosshair-top"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"crosshair-down"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"crosshair-right"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"crosshair-left"})]})]});}
;// CONCATENATED MODULE: ./src/worldSpaceUi.tsx
function WorldSpaceUi(){var globals=useGlobals();var shouldDisplayReticle=useReactiveValue(globals.displayReticle);return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"fullscreen-overlay",children:shouldDisplayReticle&&/*#__PURE__*/(0,jsx_runtime.jsx)(Reticle,{})});}
;// CONCATENATED MODULE: ./src/hud.tsx
function hud_lerp(a,b,alpha){return a+alpha*(b-a);}function LivesDisplay(_ref){var numLives=_ref.numLives,maxNumLives=_ref.maxNumLives,_ref$reversedDirectio=_ref.reversedDirection,reversedDirection=_ref$reversedDirectio===void 0?false:_ref$reversedDirectio;var maxNumSegments=maxNumLives-1;var numSegments=numLives-1;var segments=Array.from({length:maxNumSegments},function(_,i){var activeClassName=i<numSegments?"active":"";if(reversedDirection){activeClassName=maxNumSegments-i<=numSegments?"active":"";}return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"segment ".concat(activeClassName)},i);});return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"lives",children:/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"segments-container",children:/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"segments",children:segments})})});}function Hud(){var globals=useGlobals();var playerHealth=useReactiveValue(globals.playerHealth);var playerLives=useReactiveValue(globals.playerLives);var bossHealth=useReactiveValue(globals.bossHealth);var bossLives=useReactiveValue(globals.bossLives);var maxPlayerLives=useReactiveValue(globals.maxPlayerLives);var maxBossLives=useReactiveValue(globals.maxBossLives);var playerHealthPercent=hud_lerp(0,100,playerHealth);var bossHealthPercent=hud_lerp(100,0,bossHealth);var playerHealthColorBackground="rgba(255, 255, 255, 0.1)";var bossHealthColorBackground="rgba(255, 255, 255, 0.1)";return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"hud",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"flex-row padding-md",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"flex-col",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"player-healthbar",style:{background:"linear-gradient(90deg, white ".concat(playerHealthPercent,"%, ").concat(playerHealthColorBackground," ").concat(playerHealthPercent,"%, ").concat(playerHealthColorBackground," 100%)")}}),/*#__PURE__*/(0,jsx_runtime.jsx)(LivesDisplay,{numLives:playerLives,maxNumLives:maxPlayerLives})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"boss-stats",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"boss-healthbar",style:{background:"linear-gradient(90deg, ".concat(bossHealthColorBackground," ").concat(bossHealthPercent,"%, white ").concat(bossHealthPercent,"%, white 100%)")}}),/*#__PURE__*/(0,jsx_runtime.jsx)(LivesDisplay,{numLives:bossLives,maxNumLives:maxBossLives,reversedDirection:true})]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(WorldSpaceUi,{})]});}
;// CONCATENATED MODULE: ./src/gameOver.tsx
function GameOver(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var percentageDestroyed=useReactiveValue(globals.percentageDestroyed);var damageTaken=useReactiveValue(globals.damageTaken);return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"gameoverLose",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"left-column",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:"Planet saved!"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"Thanks for playing <3"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{className:"mainMenuButton",text:"[ Play Again ]",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{className:"mainMenuButton",text:"[ Quit ]",onClick:function onClick(){gameLifecycleManager.QuitGame();}})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"right-column",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"body-text",children:"".concat(Math.round(percentageDestroyed*100),"% of planet destroyed")}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"body-text",children:"".concat(damageTaken," damage taken")})]})]});}
;// CONCATENATED MODULE: ./src/debug.tsx
function Debug(){var globals=useGlobals();var route=useReactiveValue(globals.route);var gameState=useReactiveValue(globals.debugGameState);var gameLifecycleManager=globals.gameLifecycleManager;var isDebugModeEnabled=useReactiveValue(globals.debugModeEnabled);var debugStrings=useReactiveValue(globals.debugStrings);var debugStringElements=debugStrings.map(function(value,i){return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"text",children:value},i);});return isDebugModeEnabled&&/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"debug-ui",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"footer"})]});}
;// CONCATENATED MODULE: ./src/gameOverLose.tsx
function GameOverLose(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"gameover",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"left-column",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:"Planet Consumed :("}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"Try Again?"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{className:"mainMenuButton",text:"[ Play Again ]",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{className:"mainMenuButton",text:"[ Give Up ]",onClick:function onClick(){gameLifecycleManager.QuitGame();}})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"right-column"})]});}
;// CONCATENATED MODULE: ./src/controls.tsx
function Controls(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"controls",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:"Controls"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"Press"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" [ESCAPE]"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" at any time to see this again. "})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"Press"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" [Left Mouse Click]"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" and "}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" [Right Mouse Click]"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" to attack."})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"Press"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" [SPACE]"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" to jump. Press "}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" [SHIFT]"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" to dash."})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"container",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"TIP: Take down the enemy's shield to"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"highlighted",children:" stagger"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:" it."})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{className:"mainMenuButton",text:"[ Start Game ]",onClick:function onClick(){gameLifecycleManager.StartGame();}})]});}
;// CONCATENATED MODULE: ./src/index.tsx
function App(){var globals=useGlobals();var route=useReactiveValue(globals.route);var navigate=useNavigate();(0,react.useEffect)(function(){navigate(route);},[route,navigate]);return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Routes,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/",element:/*#__PURE__*/(0,jsx_runtime.jsx)("view",{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/mainMenu",element:/*#__PURE__*/(0,jsx_runtime.jsx)(MainMenu,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/controls",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Controls,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/pauseMenu",element:/*#__PURE__*/(0,jsx_runtime.jsx)(PauseMenu,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/hud",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Hud,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/gameOver",element:/*#__PURE__*/(0,jsx_runtime.jsx)(GameOver,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/gameOverLose",element:/*#__PURE__*/(0,jsx_runtime.jsx)(GameOverLose,{})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Debug,{})]});}_render(/*#__PURE__*/(0,jsx_runtime.jsx)(MemoryRouter,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(App,{})}));
})();

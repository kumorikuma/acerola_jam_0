...
function GameOver(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var percentageDestroyed=useReactiveValue(globals.percentageDestroyed);var damageTaken=useReactiveValue(globals.damageTaken);return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"gameover",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"left-column",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:"Planet saved!"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"subtext",children:"Thanks for playing <3"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{className:"mainMenuButton",text:"[ Play Again ]",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{className:"mainMenuButton",text:"[ Quit ]",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"right-column",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"body-text",children:"".concat(Math.round(percentageDestroyed*100),"% of planet destroyed")}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"body-text",children:"".concat(damageTaken," damage taken")})]})]});}
